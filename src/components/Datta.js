...
const product_1 = {
    name: "Mila dual pocket", price: 74.99, srcImage: pink, qtd:0
}
const product_2 = {
    name: "Claire high heels shoes", price: 64.99, srcImage: shoe_2, qtd:0
}
const product_3 = {
    name: "Donna gold frame", price: 40.00, srcImage: glass_3, qtd:0
}
const product_4 = {
    name: "Dora black gradient eyewear", price: 48.99, srcImage: glass_2, qtd:0
}
const product_5 = {
    name: "Alnih night dress navy", price: 199.99, srcImage: blue, qtd:0
}
const product_6 = {
    name: "Gold night party dress", price: 74.99, srcImage: golden, qtd:0
}
const product_7 = {
    name: "Noorin gold ring wacth", price: 99.99, srcImage: clock, qtd:0
}
const product_8 = {
    name: "Solla outdoor sunglasses", price: 64.99, srcImage: glass_4, qtd:0
}
const product_9 = {
    name: "Claire high heels shoes", price: 64.99, srcImage: shoe_2, qtd:0
}
const product_10 = {
    name: "Scarlett red long dress", price: 119.99, srcImage: redDress_1, qtd:0
}
const product_11 = {
    name: "Benne long sleeve shirt black", price: 87.99, srcImage: blackStyle_1, qtd:0
}
const product_12 = {
    name: "Black high heels shoes", price: 69.99, srcImage: shoe_1, qtd:0
}
